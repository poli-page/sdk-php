...
The same sync needs to happen for every other SDK that vendors the preset (sdk-go, sdk-node, sdk-python, sdk-ruby, sdk-rust). That's the trade-off of skipping the npm-published path.
